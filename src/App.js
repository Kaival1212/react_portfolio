            ...
            <nav className="mainNav">
                <ul className="mainNav_ul">
                    ...
                    <li>
                        ...
                        <a href="/" className="mainNav_ul_about" onClick={() => handleLinkClick(2)}>
                            $about me
                        </a>
                    </li>
                    <li>
                        <div className={`line3 ${activeLine === 3 ? 'active' : ''}`}></div>
                        <a href="/" className="mainNav_ul_skills" onClick={() => handleLinkClick(3)}>
                            $skills
                        </a>
                    </li>
                    <li>
                        <div className={`line4 ${activeLine === 4 ? 'active' : ''}`}></div>
                        <a href="/" className="mainNav_ul_projects" onClick={() => handleLinkClick(4)}>
                            $projects
                        </a>
                    </li>
                    <li>
                        <div className={`line5 ${activeLine === 5 ? 'active' : ''}`}></div>
                        <a href="/" className="mainNav_ul_contacts" onClick={() => handleLinkClick(5)}>
                            $contacts
                        </a>
                    </li>
                    <div></div>
